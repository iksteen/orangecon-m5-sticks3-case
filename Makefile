...
STL_COLOR_BODY := m5sticks3_click_case_petg_pla_color_body.stl
STL_COLOR_LOGO := m5sticks3_click_case_petg_pla_color_logo_insert.stl
...
THREEMF_COLOR_LOGO := m5sticks3_click_case_petg_pla_color_logo.3mf
